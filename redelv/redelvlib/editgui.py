...
class FileInfo(Receiver):
    def __init__(self,redelv, *args,**argk):
        ...
        hrow = Gtk.HBox(False, 0)
        hrow.pack_start(Gtk.Label("Size", True, True, 0),False,True,0)        
        self.size = Gtk.Entry()
        self.size.set_editable(False)
        hrow.pack_start(self.size,True,True,0)
        hrow.pack_start(Gtk.Label("Offset on Disk", True, True, 0),False,True,0)
...
class FileMetadata(Receiver):
	...
	pbox = Gtk.VBox(False,2)
        ...
        trow = Gtk.HBox(False,0)
        trow.pack_start(Gtk.Label("Master Index Offset:", True, True, 0),False,True,0)
        ...
        trow.pack_start(Gtk.Label("Master Index Length:", True, True, 0),False,True,0)
        ...
        trow = Gtk.HBox(False,0)
        trow.pack_start(Gtk.Label("Source:", True, True, 0),False,True,0)
